        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="categorie" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    <i class='bx bx-category'></i>Catégorie</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Catégorie</h2>
                </div>
...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('categorie.create') }}"> Créer une nouvelle Catégorie</a><br><br>
            </div>
        </div>
    </div>
    ...
    @endif
        ...
        <tr style="border: 1px solid black;">
            <td style="border: 1px solid black;">{{ $categorie->id }}</td>
            <td style="border: 1px solid black;">{{ $categorie->name }}</td>

            <td style="border: 1px solid black;">
                <a class="btn btn-info" href="{{ route('categorie.show',$categorie->id) }}">Détail</a>
