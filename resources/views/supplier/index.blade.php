...
<body>
            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="supplier" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    ...
                    <a href="order" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                        <i class='bx bx-group' ></i>Commande</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Fournisseurs</h2>
                </div>
 ...
 <h1 style="text-align:center;">Fournisseur</h1>
 ...
 border-width: 5px; border-color:black; border-radius: 10px;
   padding: 5px;">
    <tr style="border: 1px solid black;">
        ...
        <th style="border: 1px solid black;">Télephone</th>
...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('supplier.create') }}"> Creer un nouveau Fournisseur</a><br><br>
            </div>
        </div>
    </div>
    ...
    @endif
        ...
        <tr style="border: 1px solid black;">
            ...
            <td style="border: 1px solid black;">{{ $supplier->id }}</td>
            <td style="border: 1px solid black;">{{ $supplier->code }}</td>
            <td style="border: 1px solid black;">{{ $supplier->name }}</td>
            <td style="border: 1px solid black;">{{ $supplier->email }}</td>
            <td style="border: 1px solid black;">{{ $supplier->phone }}</td>
            <td style="border: 1px solid black;">{{ $supplier->fix }}</td>
            <td style="border: 1px solid black;">{{ $supplier->adress }}</td>
            <td style="border: 1px solid black;">
                <a class="btn btn-info" href="{{ route('supplier.show',$supplier->id) }}">Détail</a>

                <a class="btn btn-primary" href="{{ route('supplier.edit',$supplier->id) }}">Modifier</a>

                <form action="{{ route('supplier.destroy',$supplier->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button type="submit" class="btn btn-danger"><i class="material-icons">Supprimer</button>
                </form>
            </td>
        </tr>
        @endforeach
