            ...
            <div class="list-group list-group-flush my-3">
                ...
                <a href="supplier" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                    ...
                    <a href="order" class="list-group-item list-group-item-action bg-transparent second-text fw-bold">
                        <i class='bx bx-command'></i>Order</a>
        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h2 class="fs-2 m-0">Bon De Commande</h2>
                </div>
...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            <div class="pull-right">
                <a class="btn btn-success" href="{{ route('bc.create') }}"> Creer un Bon de Commande</a><br><br>
            </div>
        </div>
    </div>
    ...
    @endif
        ...
        @foreach ($bc as $bc)
        <tr style="border: 1px solid black;">
            <td style="border: 1px solid black;">{{ $bc->id }}</td>
            <td style="border: 1px solid black;">{{ $bc->reference }}</td>
            <td style="border: 1px solid black;">
                <a class="btn btn-info" href="{{ route('bc.show',$bc->id) }}">Détail</a>

                <a class="btn btn-primary" href="{{ route('bc.edit',$bc->id) }}">Modifier</a>

                <form action="{{ route('bc.destroy',$bc->id) }}" method="POST">
                    @csrf
                    @method('DELETE')
